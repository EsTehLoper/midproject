...
<div class="HEADER">
    ...
    <img src="<?php echo e(asset('images/chipi-chipi-chapa-chapa.gif')); ?>" alt="Animated GIF">
            ...
            <div class="modal-body">
                <form action="#" id="myForm">
                    <div class="card imgholder">
                        ...
                        <img src="<?php echo e(asset('images/Profile-Icon.jpg')); ?>" alt="" width="200" height="200" class="img">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" id="myForm">
                    <div class="card imgholder">
                        <img src="<?php echo e(asset('./image/Profile Icon.webp')); ?>" alt="" width="200" height="200" class="showImg">
                    </div>
                    <div class="inputField">
                        <div>
                            <label for="name">Nama:</label>
...
<?php /**PATH C:\Users\darre\OneDrive\Documents\BINUS\BNCC\LnT\Back End BE-6\Mid Project\midproject\resources\views/welcome.blade.php ENDPATH**/ ?>